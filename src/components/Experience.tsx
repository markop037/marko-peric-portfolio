...
const experiences = [
  {
    ...
    responsibilities: [
      ...
      "Designing trading strategies, running backtests, and tweaking performance",
      "Making sure the bots work reliably and are properly integrated with the MT5 platform",
      "Handling deployment, giving clients access, and fixing issues as they come up",
    ],
    current: true,
  },
  {
    ...
    responsibilities: [
      ...
      "Worked on real-time, word-by-word streaming responses using WebSockets",
