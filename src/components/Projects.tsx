...
const projects = [
  {
    ...
    features: [
      ...
      "Trading Bot Catalog & Bot Picker",
      "One-time Checkout",
      "User Dashboard & File Downloads",
      "Email & PDF Delivery",
    ],
    technologies: [
      "Next.js",
    ...
    description:
      "Full-stack marketplace where traders can buy and download ready-made MT5 Expert Advisors and indicators. Includes secure auth, a one-time checkout flow, a file download dashboard, a bot picker tool, a blog, and email delivery for a PDF guide.",
    github: null,
    liveUrl: "https://traders-market-nine.vercel.app/",
    color: "from-amber-500 to-orange-500",
  },
  {
    title: "MyWallet",
    subtitle: "Personal Finance & Expense Tracker Web App",
    icon: Wallet,
    features: [
    ...
    description:
      "A personal finance web app where you can log income and expenses, track your balance in real time, and view pie charts broken down by category. Built with a React/TypeScript frontend and a FastAPI backend connected to a PostgreSQL database on Supabase.",
    liveUrl: "https://mywallet-project-phi.vercel.app",
